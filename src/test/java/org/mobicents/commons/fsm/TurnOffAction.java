 ...
 */
@NotThreadSafe public final class TurnOffAction implements Action {
  private final LightBulb lightbulb;
  
  public TurnOffAction(final LightBulb lightbulb) {
    super();
  ...
  @Override public void execute(final Event<?> event, final State state) {
    ...
    buffer.append(lightbulb.getClass().getName()).append(" Off");
